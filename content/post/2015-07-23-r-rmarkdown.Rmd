...
ggplot(data = Daily, aes(x = SECTOR, y = CAPACITY, fill = SECTOR)) + geom_point(aes(fill = SECTOR)) + geom_violin(scale="area") + theme_solarized()


ggplot(data = Daily, aes(x = SECTOR, y = SHELTER_CITY, fill = SHELTER_CITY)) + geom_point(aes(fill = SECTOR))
